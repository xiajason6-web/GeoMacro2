...
| US × post-Dec-2024 (incremental) | -0.856 | -57.5% | 0.147 | 0.070 |
| **Cumulative, all three waves** | **-1.606** | **-79.9%** | — | — |

US equipment exports to China ran **80% below**
...
|---|---|---|---|
| Cumulative US effect (log pts) | -1.606 | -1.557 | -1.397 |
| Cumulative level effect | -79.9% | -78.9% | -75.3% |
...
- **Allied tightening.** The Netherlands/Japan later adopted partial
  ...
  larger.
- **HS 8486 scope.** Measured clean — flat-panel tools (8486.30) are
  ~0% of China-bound 8486; the basket is 88% semiconductor-device/IC
  machines. Taiwan origin is unobserved (permanent `missing_origins`).
