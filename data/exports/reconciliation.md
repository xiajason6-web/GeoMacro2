# Consensus reconciliation — 2025

Our v2 annual ratio for 2025: **18.7%** (sum of four quarters,
...
|---|---|---|---|---|---|
| Bernstein (via BigGo Finance) | 2025 | 21% | 18.7% (v2 headline) | +2.3% | Chinese vendors' semiconductor-equipment sales (all domestic vendors) |
| CSIS | 2025 | 35% | 18.7% (v2 headline) | +16.3% | Chinese-made semiconductor manufacturing equipment |
| UBS (via EE Times) | 2025 | 20% | 15.7% (3-company variant) | +4.3% | ACM Research + AMEC + Naura ONLY (3 companies — narrower than this tracker's 6) |
